...
def create_referral(
    ...
    """
    try:
        logger.debug("Received referral payload: %s", referral_data)
        
        # Convert camelCase to snake_case
        converted_data = convert_camel_to_snake(referral_data)
        logger.debug("Converted referral payload: %s", converted_data)
        ...
        logger.exception("Error creating referral")
        raise HTTPException(
